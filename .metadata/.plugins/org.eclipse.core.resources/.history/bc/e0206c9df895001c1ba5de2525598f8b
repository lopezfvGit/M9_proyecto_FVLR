...
public class CurriculumBean implements Serializable {
	...
	public String registrar() {
		...
		//mensajeRespuesta="Felicidades + nombre +  tu cv con conocimientos  + conocimientos +  ha quedado registrado";
		messageBean.setMensaje("Felicidades tu cv con conocimientos "+conocimientos+" ha quedado registrado");
		//setMensaje("Felicidades tu cv con conocimientos "+conocimientos+" ha quedado registrado");
		//messageBean.return "index";
		return "index";
	}
